...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url=f'https://t.me/KP51107')
            ]]
            reply_markup=InlineKeyboardMarkup(buttons)
            k = await message.reply(
                text='<b>CHAT NOT ALLOWED 🐞\n\nMy owner has restricted me from working here ! If you want to know more about it contact owner..</b>',
        ...
        [[
            InlineKeyboardButton('👤 SUPPORT', url='https://t.me/+H7C-jaN_LZ05Mjc1')
        ]],
        reply_markup=InlineKeyboardMarkup(buttons)
        await message.reply_text(
            text=f"<b>Thankyou For Adding Me In {message.chat.title} ❣️\n\nIf you have any questions & doubts about using me click support.</b>",
            reply_markup=reply_markup)
    else:
...
async def leave_a_chat(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=chat,
            text='<b>Hello Friends, \nMy Owner has told me to leave from this group so iam going! If you wanna add me again contact my owner.</b>',
            reply_markup=reply_markup,
        )
